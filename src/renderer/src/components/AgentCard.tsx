      ...
      >
        ...
        {(isolation || runInBackground) && (
          <div className="flex gap-1 flex-shrink-0">
            {isolation && <span className="bg-[#3a3a20] text-[#ccaa66] px-[6px] py-[1px] rounded text-[0.78em] font-['SF_Mono','Fira_Code',monospace]">{isolation}</span>}
            {runInBackground && <span className="bg-[#2a3a2a] text-[#88cc88] px-[6px] py-[1px] rounded text-[0.78em] font-['SF_Mono','Fira_Code',monospace]">bg</span>}
          </div>
        )}
        ...
        <>
          {prompt && (
            <div className="px-3 py-2 border-t border-[#3a4a5a] bg-[#141e2a]">
              ...
              <div className="message-content text-[0.9em] leading-[1.5] text-[#b0b0b0] max-h-[250px] overflow-y-auto bg-[#0d0d1a] border border-[#3a3a4a] rounded p-2 [&_p]:mb-[6px] [&_p:last-child]:mb-0 [&_code]:bg-[#2a2a3a] [&_code]:px-1 [&_code]:rounded-[3px] [&_code]:font-['SF_Mono','Fira_Code',monospace] [&_code]:text-[0.9em]">
          ...
          {result && (
            <div className="px-3 py-2 border-t border-[#3a4a5a] bg-[#141e2a]">
              ...
              <div className="message-content text-[0.9em] leading-[1.5] text-[#b0b0b0] max-h-[400px] overflow-y-auto bg-[#0d0d1a] border border-[#3a3a4a] rounded p-2 [&_p]:mb-[6px] [&_p:last-child]:mb-0 [&_code]:bg-[#2a2a3a] [&_code]:px-1 [&_code]:rounded-[3px] [&_code]:font-['SF_Mono','Fira_Code',monospace] [&_code]:text-[0.9em]">
